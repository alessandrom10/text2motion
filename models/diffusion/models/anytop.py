...
from models.diffusion.models.motion_transformer import GraphMotionDecoderLayer, GraphMotionDecoder
...
class AnyTop(nn.Module):
    ...
    def forward(self, x, timesteps, get_layer_activation=-1, y=None):
        ...
        text_embed = y['text_embed'].to(x.device) if 'text_embed' in y else None
